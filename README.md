...
Open the operations Console at `http://localhost:5100`. For the standalone end-user Workplace and its Work API, follow the [local installation guide](docs/getting-started/local-installation.md).
