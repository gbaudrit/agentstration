...
public sealed class PostgreSqlRuntimeRunStore(IDbContextFactory<RuntimeRunDbContext> contextFactory, TimeProvider timeProvider) : IRuntimeRunStore
{
    ...
    public async Task InitializeAsync(CancellationToken cancellationToken)
    {
        ...
        if (!await context.Database.CanConnectAsync(cancellationToken)) throw new InvalidOperationException("The PostgreSQL Runtime store is not accessible.");
    }
...
public sealed class PostgreSqlRuntimeExecutionStateStore(
...
public static class PostgreSqlRuntimeRunServiceCollectionExtensions
{
    public static IServiceCollection AddPostgreSqlRuntimeRuns(this IServiceCollection services, string connectionString)
    {
