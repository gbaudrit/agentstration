...
public enum ResourcePlanProposedOperation { Create, Update, Delete, NoOp }
...
public sealed record ResourcePlanIntegrationBinding(string LogicalId, ResourceReference Tool);
public sealed record ResourcePlanBindingDraft(ResourcePlanId PlanId, ResourcePlanScope Scope, long PlanRevision,
    ...
    IReadOnlyList<ResourcePlanIntegrationBinding>? IntegrationBindings = null);
