...
public partial class Home
{
    ...
    private static EntryResource ToDefinition(EntryResponse value) => new() { Id = new(value.Id), Name = value.Name, DisplayName = value.DisplayName, Description = value.Description, Presentation = value.Presentation, Target = value.Target, Behavior = value.Behavior, ResourceGroup = value.ResourceGroup, Location = value.Location, ApiVersion = value.ApiVersion, Type = value.Type };
