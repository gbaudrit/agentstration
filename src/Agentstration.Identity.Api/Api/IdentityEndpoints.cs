...
public static class IdentityEndpoints
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return Results.Ok(ToResponse(await service.GetAsync(principalId.Value, cancellationToken)));
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            return Results.Ok(ToResponse(await service.UpdateAsync(principalId.Value, request.Theme, request.Language, cancellationToken)));
        }
        catch (ArgumentException exception)
        {
