...
public sealed class PlatformDbContext(DbContextOptions<PlatformDbContext> options) : DbContext(options)
{
    ...
    public DbSet<MemoryEntryRow> MemoryEntries => Set<MemoryEntryRow>();
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<MemoryEntryRow>(entity => { entity.ToTable("memory_entries"); entity.HasKey(x => x.Id); entity.HasIndex(x => new { x.WorkspaceId, x.ItemId, x.CreatedAt }); });
...
public sealed class MemoryEntryRow { public Guid Id { get; set; } public Guid WorkspaceId { get; set; } public Guid? ItemId { get; set; } public Guid? MissionId { get; set; } public required string Kind { get; set; } public required string Content { get; set; } public required string CategoriesJson { get; set; } public DateTimeOffset CreatedAt { get; set; } }
