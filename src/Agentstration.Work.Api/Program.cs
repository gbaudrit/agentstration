...
var flowPath = builder.Configuration["Data:FlowPath"] ?? Path.Combine(dataDirectory, "flow-plane.db");
...
var app=builder.Build();app.UseExceptionHandler();app.UseStatusCodePages();if(app.Environment.IsDevelopment()||app.Environment.IsEnvironment("Testing"))app.MapOpenApi();app.MapHealthChecks("/health");app.MapGet("/api/workspaces", WorkplaceEndpoints.ListWorkspacesAsync);app.MapAgentstrationWorkApi();app.MapAgentstrationWorkplaceApi();app.MapAgentstrationWorkOperationsApi();app.MapAgentstrationFlowApi();app.MapHub<WorkplaceHub>("/hubs/workplace");
