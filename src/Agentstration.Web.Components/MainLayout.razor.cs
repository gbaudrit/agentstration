...
public partial class MainLayout
{
    ...
    [
        ...
        new("Group.Operate", [new("Nav.ResourcePlans", "/resource-plans", "layers", "work", ["resources/read"]), new("Nav.Triggers", "/triggers", "clock", "work"), new("Nav.Deployments", "/deployments", "server", "runtime"), new("Nav.Tasks", "/tasks", "tasks", "work")]),
    ...
    [
        ...
        new("Nav.ResourcePlans", "/resource-plans", "◇", "Group.Operate", "planning plans resources ressources review revue", ["resources/read"]),
