...
public partial class MainLayout
{
    ...
    [
        ...
        new("Group.System", [new("Nav.Organization", "/settings/organization", "building"), new("Nav.Bootstrap", "/settings/bootstrap", "upload-cloud"), new("Nav.Cleanup", "/cleanup", "trash", RequiredPermissions: ["resources/delete", "runs/delete"]), new("Nav.Settings", "/settings", "settings")])
    ];

    private static readonly CommandDefinition[] CommandDefinitions =
    [
        new("Nav.Overview", "/", "⌂", "Navigate"),
        new("Nav.Agents", "/agents", "◎", "Group.Design", "agent resources agents ressources"),
        new("Command.CreateAgent", "/agents/new", "+", "Command", "new nouveau agent"),
        new("Nav.ModelProfiles", "/modelprofiles", "◇", "Group.Design", "models modèles"),
        new("Command.CreateModelProfile", "/modelprofiles/new", "+", "Command", "new nouveau model modèle"),
        new("Nav.Flows", "/flows", "⌘", "Group.Design", "workflow designer flux conception"),
        new("Command.CreateFlow", "/flows/new", "+", "Command", "new nouveau workflow flux"),
        new("Nav.Entries", "/entries", "↳", "Group.Design", "workplace entry entrée"),
        new("Command.CreateEntry", "/entries/new", "+", "Command", "new nouvelle workplace entry entrée"),
        new("Nav.ResourcePlans", "/resource-plans", "◇", "Group.Design", "planning plans resources ressources review revue", ["resources/read"]),
        new("Nav.Deployments", "/deployments", "◉", "Group.Observe", "agent runtime deployments déploiements"),
        new("Nav.AgentRuns", "/agent-runs", "▶", "Group.Observe", "agent execution history exécution historique"),
        new("Nav.FlowRuns", "/flow-runs", "▷", "Group.Observe", "workflow executions flux exécutions"),
        ...
        new("Nav.Triggers", "/triggers", "◷", "Group.Automate", "schedule automation planification automatisation"),
        new("Nav.RunEvents", "/run-events", "≋", "Group.Observe", "persisted runtime flow activity événements"),
        new("Nav.ModelProviders", "/modelproviders", "⬡", "Group.Integrations", "providers fournisseurs"),
        new("Nav.Tools", "/tools", "⌁", "Group.Integrations", "tool catalog providers outils fournisseurs MCP AEP"),
        ...
        new("Nav.WorkplaceSetup", "/workspaces", "▦", "Group.Workplace", "workspace composition primary entries espace composition"),
        new("Nav.Packs", "/packs", "▣", "Group.Resources", "package distribution install archive resources paquet installation"),
        new("Command.CreateModelProvider", "/modelproviders/new", "+", "Command", "new nouveau provider fournisseur"),
        new("Nav.SourceProviders", "/sourceproviders", "◫", "Group.Integrations", "source providers fournisseurs Git AEP"),
        new("Command.CreateSourceProvider", "/sourceproviders/new", "+", "Command", "new nouveau source provider fournisseur"),
        new("Nav.RuntimeProfiles", "/runtimeprofiles", "◈", "Group.Configuration", "runtime configuration exécution"),
        new("Command.CreateRuntimeProfile", "/runtimeprofiles/new", "+", "Command", "new nouveau runtime profile profil"),
        new("Nav.Secrets", "/secrets", "◆", "Group.Configuration", "credentials Vaults write only secrets identifiants coffres"),
        new("Command.CreateSecret", "/secrets/new", "+", "Command", "new nouveau credential secret"),
        new("Command.Vaults", "/vaults", "▰", "Group.Configuration", "secret storage providers coffres stockage"),
        ...
        new("Nav.ResourceScopes", "/settings/resource-scopes", "◇", "Group.Configuration", "resource ownership hierarchy scopes ressources propriété hiérarchie", ["resources/read"]),
        new("Nav.Sources", "/settings/sources", "▤", "Group.Resources", "sources catalogs reusable content catalogues contenu réutilisable"),
        new("Nav.SourceRegistries", "/settings/source-registries", "◫", "Group.Resources", "registry registries discovery trust registre registres découverte confiance"),
        ...
        new("Command.ProfileSettings", "/settings/profile", "○", "Nav.Profile", "appearance theme personal preferences apparence thème préférences"),
        new("Nav.Extensions", "/extensions", "⬢", "Group.Integrations", "AEP option contracts compatibility extensions"),
