...
public static class AepProtocol
{
    ...
    public const string DiscoveryPath = "/.well-known/agentstration";
...
public sealed record AepExtensionDescriptor(
    string ProtocolVersion,
    AepExtensionIdentity Extension,
    AepExtensionCapabilities Capabilities,
    AepContributions Contributions,
    AepMcpDescriptor? Mcp = null);

public sealed record AepExtensionCapabilities(bool Health = true);
...
{
    public static IReadOnlyList<string> Validate(AepExtensionDescriptor descriptor)
    {
