...
internal sealed class SourceEndpoints : IManagementEndpoint
{
    ...
    private static Task<IResult> ListConsoleAsync(
        ISourceConsoleQueryService service,
        ICurrentRequestContext requestContext,
        CancellationToken cancellationToken) =>
        SourcesApiHttp.ExecuteAsync(async () => Results.Ok(
    ...
    private static Task<IResult> GetConsoleAsync(
        ...
        ICurrentRequestContext requestContext,
        CancellationToken cancellationToken) =>
        SourcesApiHttp.ExecuteAsync(async () => Results.Ok(await service.GetAsync(
    ...
    private static Task<IResult> ConfigureConsoleBindingsAsync(
        ...
        {
            var ifMatch = SourcesApiHttp.IfMatch(request)
    ...
    private static Task<IResult> ImportYamlAsync(
        ...
        SourcesApiHttp.ExecuteAsync(async () =>
        {
            SourcesApiHttp.RequireApiVersion(httpRequest);
    ...
    private static Task<IResult> ListAsync(SourceManagementService service, CancellationToken cancellationToken) =>
        SourcesApiHttp.ExecuteAsync(async () => Results.Ok(await service.ListAsync(cancellationToken)));
    ...
    private static Task<IResult> UpdateRefreshPolicyAsync(
        ...
        SourcesApiHttp.ExecuteAsync(async () =>
        {
            var ifMatch = SourcesApiHttp.IfMatch(httpRequest)
            ...
            return SourcesApiHttp.ResourceResult(updated, response, StatusCodes.Status200OK);
        });
    ...
    private static Task<IResult> ListVersionsAsync(
        ...
        SourceManagementService service,
        CancellationToken cancellationToken) =>
        SourcesApiHttp.ExecuteAsync(async () => Results.Ok(Scope(scopeRef) is { } scope
    ...
    private static Task<IResult> ListChannelSnapshotsAsync(
        ...
        SourceManagementService sources,
        CancellationToken cancellationToken) =>
        SourcesApiHttp.ExecuteAsync(async () => Results.Ok(await service.ListAsync(
    ...
    private static Task<IResult> GetChannelStatusAsync(
        ...
        SourceManagementService sources,
        CancellationToken cancellationToken) =>
        SourcesApiHttp.ExecuteAsync(async () => Results.Ok(await service.GetStatusAsync(
            await ResolveScopeAsync(scopeRef, publisher, name, sources, cancellationToken),
            publisher, name, versionUid, channel, cancellationToken)));
    ...
    private static Task<IResult> BrowseCatalogsAsync(
        ...
        SourceManagementService sources,
        CancellationToken cancellationToken) =>
        SourcesApiHttp.ExecuteAsync(async () => Results.Ok(await service.BrowseAsync(
            await ResolveScopeAsync(scopeRef, publisher, name, sources, cancellationToken),
