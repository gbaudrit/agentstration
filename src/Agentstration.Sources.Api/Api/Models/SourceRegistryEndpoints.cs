...
public static class SourceRegistryEndpoints
{
    ...
    private static Task<IResult> SearchAsync(
        ...
        SourcesApiHttp.ExecuteAsync(async () => Results.Ok(await service.SearchAsync(new()
        {
            Search = search,
            Publisher = publisher,
            Registry = registry,
    ...
    private static Task<IResult> UpdateAsync(
        ...
        SourcesApiHttp.ExecuteAsync(async () =>
        {
            var stored = await service.UpdateAsync(registryName, body.Properties, SourcesApiHttp.IfMatch(request), cancellationToken);
    ...
    private static Task<IResult> DeleteAsync(
        ...
        SourcesApiHttp.ExecuteAsync(async () =>
        {
            await service.DeleteAsync(registryName, SourcesApiHttp.IfMatch(request), cancellationToken);
