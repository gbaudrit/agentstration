...
public sealed class PendingActionPanelTests
{
    ...
    public void WorkplaceLayoutUsesTheConsoleDesignSystemShell()
    {
        ...
        Assert.IsTrue(rendered.Find(".mobile-brand-logo").GetAttribute("src")?.EndsWith("agentstration-workplace-lockup-white-transparent-v2.png", StringComparison.Ordinal));
