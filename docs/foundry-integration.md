...
2. **Local Aspire discovery test:** explicit AppHost User Secrets opt-in; the existing AEP enrollment path applies, but only FR-445 discovery is available.
