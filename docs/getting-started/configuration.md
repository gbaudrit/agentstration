...
| `Foundry:Enabled` | `false` | AppHost-only opt-in to start the discovery-only Foundry AEP extension; configure endpoints and authentication in AppHost User Secrets. |
