...
- Shared Management compatibility types live in `Management.Abstractions`; validation and use cases live in plural resource-family modules; EF Core lives in `ResourceManagement.Storage.*` or family-specific storage projects.
