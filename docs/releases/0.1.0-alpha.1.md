...
```text
docker.io/gbaudrit/agentstration:0.1.0-alpha.1
docker.io/gbaudrit/agentstration:alpha
```
...
```powershell
docker run --rm -p 5100:8080 -e AI__Provider=Deterministic -v agentstration-data:/data gbaudrit/agentstration:0.1.0-alpha.1
```
