...
96. [ADR-0096 — Compose runs official AEP extensions as internal services](0096-compose-runs-official-aep-extensions-as-services.md)
97. [ADR-0097 — Compose owns its local Ollama service](0097-compose-owns-its-local-ollama-service.md)
98. [ADR-0098 — Provider-specific Compose owns inference services](0098-provider-specific-compose-owns-inference-services.md)
