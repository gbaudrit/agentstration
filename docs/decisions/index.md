...
104. [ADR-0104 — Flows compose reusable Flows and governed Tools](0104-flows-compose-flows-and-governed-tools.md)
105. [ADR-0105 — ToolDefinitions publish Flow-backed MCP Tools](0105-tool-definitions-publish-flow-backed-mcp-tools.md)
106. [ADR-0106 — Notification channels are delivery Flows](0106-notification-channels-are-delivery-flows.md)
107. [ADR-0107 — Flow Run causality is a bounded read model](0107-flow-run-causality-is-a-read-model.md)
