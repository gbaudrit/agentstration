...
- The initial Extensions Console is an operational, read-only inventory derived from workspace Model Provider declarations. It shows live extension identity, contributions, published contracts, pinned Model Profile usages, and incompatibilities. Installation, upgrade orchestration, and automatic option migration are separate future decisions.
