...
| Resource Planning | durable Workspace-scoped Resource Plans, lifecycle, provenance, activity history and optimistic revisions, distinct from executable Resources | deterministic materialization, review, validation and governed application |
