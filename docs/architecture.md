...
- ADR-0040: trusted Console API session propagation
- ADR-0041: durable Identity schema and Data Protection key material
- ADR-0042: append-only Management security audit
