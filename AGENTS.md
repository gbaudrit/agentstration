...
- `Agentstration.Management.Abstractions` retains only compatibility resources awaiting explicit family extraction. Identity, authorization and PAT contracts belong to `Agentstration.Identity.Contracts`; provider-neutral audit contracts belong to `Agentstration.Security.Contracts`; core Source contracts and provider ports belong to `Agentstration.Sources.Contracts`. Do not create another catch-all Management business module.
